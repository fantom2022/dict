...
CREATE TABLE "dict_storehouse" (
  ...
  "is_archived" boolean)
  ;
  ALTER TABLE "dict_storehouse" ADD CONSTRAINT "dict_storehouse_pkey" PRIMARY KEY ("id");
  ALTER TABLE "dict_storehouse" ADD CONSTRAINT "dict_storehouse_code_unique" UNIQUE ("code");
